...
public class AttributeBuffer extends ByteBuf {
     ...
     * @param endianness
     * @return
     * @see io.netty.buffer.ByteBuf#order(ByteOrder)
     * @deprecated
     */
    @Deprecated
    @Override
     ...
     * @param dst
     * @return
     * @see io.netty.buffer.ByteBuf#getBytes(int, ByteBuffer)
     */
    @Override
     ...
     * @return
     * @throws IOException
     * @see io.netty.buffer.ByteBuf#getBytes(int, OutputStream, int)
     */
    @Override
     ...
     * @return
     * @throws IOException
     * @see io.netty.buffer.ByteBuf#getBytes(int, FileChannel,
     *      long, int)
     */
    @Override
     ...
     * @param src
     * @return
     * @see io.netty.buffer.ByteBuf#setBytes(int, ByteBuffer)
     */
    @Override
     ...
     * @return
     * @throws IOException
     * @see io.netty.buffer.ByteBuf#setBytes(int, InputStream, int)
     */
    @Override
     ...
     * @return
     * @throws IOException
     * @see io.netty.buffer.ByteBuf#setBytes(int, FileChannel,
     *      long, int)
     */
    @Override
     ...
     * @param charset
     * @return
     * @see io.netty.buffer.ByteBuf#setCharSequence(int, CharSequence,
     *      Charset)
     */
    @Override
     ...
     * @param dst
     * @return
     * @see io.netty.buffer.ByteBuf#readBytes(ByteBuffer)
     */
    @Override
     ...
     * @return
     * @throws IOException
     * @see io.netty.buffer.ByteBuf#readBytes(OutputStream, int)
     */
    @Override
     ...
     * @return
     * @throws IOException
     * @see io.netty.buffer.ByteBuf#readBytes(GatheringByteChannel,
     *      int)
     */
    @Override
     ...
     * @param charset
     * @return
     * @see io.netty.buffer.ByteBuf#readCharSequence(int, Charset)
     */
    @Override
     ...
     * @return
     * @throws IOException
     * @see io.netty.buffer.ByteBuf#readBytes(FileChannel,
     *      long, int)
     */
    @Override
     ...
     * @param src
     * @return
     * @see io.netty.buffer.ByteBuf#writeBytes(ByteBuffer)
     */
    @Override
     ...
     * @return
     * @throws IOException
     * @see io.netty.buffer.ByteBuf#writeBytes(InputStream, int)
     */
    @Override
     ...
     * @return
     * @throws IOException
     * @see io.netty.buffer.ByteBuf#writeBytes(ScatteringByteChannel,
     *      int)
     */
    @Override
     ...
     * @return
     * @throws IOException
     * @see io.netty.buffer.ByteBuf#writeBytes(FileChannel,
     *      long, int)
     */
    @Override
     ...
     * @param charset
     * @return
     * @see io.netty.buffer.ByteBuf#writeCharSequence(CharSequence,
     *      Charset)
     */
    @Override
     ...
     * @param charset
     * @return
     * @see io.netty.buffer.ByteBuf#toString(Charset)
     */
    @Override
     ...
     * @param charset
     * @return
     * @see io.netty.buffer.ByteBuf#toString(int, int, Charset)
     */
    @Override
     ...
     * @param obj
     * @return
     * @see io.netty.buffer.ByteBuf#equals(Object)
     */
    @Override
     ...
     * @param hint
     * @return
     * @see io.netty.buffer.ByteBuf#touch(Object)
     */
    @Override
